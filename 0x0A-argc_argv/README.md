...
**File - `0-whatsmyname.c`**: C program that prints its name, followed by a new line.
...
**File - `100-change.c`:** C program that prints the minimum number of coins to make change for an amount of money.
