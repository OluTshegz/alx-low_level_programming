...
**Files - `7-insert_dnodeint.c`, `2-add_dnodeint.c`, and `3-add_dnodeint_end.c`:** Write a function that inserts a new node at a given position.
...
**File - `100-password`:** Find the password for  [crackme4](https://github.com/alx-tools/0x17.c "crackme4").
...
**File - `103-keygen.c`:** Write a keygen for  [crackme5](https://github.com/alx-tools/0x17.c "crackme5").
