...
C a program that performs simple operations.
...
**File - `100-main_opcodes.c`:** Write a program that prints the  [opcodes](https://intranet.alxswe.com/rltoken/5eSu8Ohx0ddeNGmaeDo_zQ "opcodes")  of its own main function.
