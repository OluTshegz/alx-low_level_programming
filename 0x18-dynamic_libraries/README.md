...
**Files - `libdynamic.so`, and `main.h`:** Create the dynamic library libdynamic.so containing all the functions listed below:
...
**File - `100-operations.so`:** Create a dynamic library that contains C functions that can be called from Python. See example for more detail.
