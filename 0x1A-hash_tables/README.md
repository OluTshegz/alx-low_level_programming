...
**File - `100-sorted_hash_table.c`:** In  [PHP](https://intranet.alxswe.com/rltoken/UoWjDMSf7CR02W8bnn1geg "PHP"), hash tables are  **ordered**. Wait… WAT? How is this even possible?  
